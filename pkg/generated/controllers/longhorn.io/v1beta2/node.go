...
type NodeHandler func(string, *v1beta2.Node) (*v1beta2.Node, error)
...
type NodeClient interface {
	Create(*v1beta2.Node) (*v1beta2.Node, error)
	Update(*v1beta2.Node) (*v1beta2.Node, error)
	UpdateStatus(*v1beta2.Node) (*v1beta2.Node, error)
	Delete(namespace, name string, options *metav1.DeleteOptions) error
	Get(namespace, name string, options metav1.GetOptions) (*v1beta2.Node, error)
	List(namespace string, opts metav1.ListOptions) (*v1beta2.NodeList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Node, err error)
}

type NodeCache interface {
	Get(namespace, name string) (*v1beta2.Node, error)
	List(namespace string, selector labels.Selector) ([]*v1beta2.Node, error)

	AddIndexer(indexName string, indexer NodeIndexer)
	GetByIndex(indexName, key string) ([]*v1beta2.Node, error)
}

type NodeIndexer func(obj *v1beta2.Node) ([]string, error)
...
func FromNodeHandlerToHandler(sync NodeHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		...
		if obj == nil {
			...
			v, err = sync(key, obj.(*v1beta2.Node))
		}
		if v == nil {
			return nil, err
		}
...
func (c *nodeController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1beta2.Node))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateNodeDeepCopyOnChange(client NodeClient, obj *v1beta2.Node, handler func(obj *v1beta2.Node) (*v1beta2.Node, error)) (*v1beta2.Node, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *nodeController) Create(obj *v1beta2.Node) (*v1beta2.Node, error) {
	result := &v1beta2.Node{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *nodeController) Update(obj *v1beta2.Node) (*v1beta2.Node, error) {
	result := &v1beta2.Node{}
	return result, c.client.Update(context.TODO(), obj.Namespace, obj, result, metav1.UpdateOptions{})
}

func (c *nodeController) UpdateStatus(obj *v1beta2.Node) (*v1beta2.Node, error) {
	result := &v1beta2.Node{}
...
func (c *nodeController) Get(namespace, name string, options metav1.GetOptions) (*v1beta2.Node, error) {
	result := &v1beta2.Node{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *nodeController) List(namespace string, opts metav1.ListOptions) (*v1beta2.NodeList, error) {
...
func (c *nodeController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta2.Node, error) {
	result := &v1beta2.Node{}
...
func (c *nodeCache) Get(namespace, name string) (*v1beta2.Node, error) {
...
func (c *nodeCache) List(namespace string, selector labels.Selector) (ret []*v1beta2.Node, err error) {
...
func (c *nodeCache) AddIndexer(indexName string, indexer NodeIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1beta2.Node))
		},
	}))
}

func (c *nodeCache) GetByIndex(indexName, key string) (result []*v1beta2.Node, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1beta2.Node, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1beta2.Node))
	}
	return result, nil
}
...
func (a *nodeStatusHandler) sync(key string, obj *v1beta2.Node) (*v1beta2.Node, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *nodeGeneratingHandler) Remove(key string, obj *v1beta2.Node) (*v1beta2.Node, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *nodeGeneratingHandler) Handle(obj *v1beta2.Node, status v1beta2.NodeStatus) (v1beta2.NodeStatus, error) {
