...
var blockdevicesResource = schema.GroupVersionResource{Group: "harvesterhci.io", Version: "v1beta1", Resource: "blockdevices"}

var blockdevicesKind = schema.GroupVersionKind{Group: "harvesterhci.io", Version: "v1beta1", Kind: "BlockDevice"}
...
func (c *FakeBlockDevices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BlockDevice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(blockdevicesResource, c.ns, name), &v1beta1.BlockDevice{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.BlockDevice), err
}
...
func (c *FakeBlockDevices) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BlockDeviceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(blockdevicesResource, blockdevicesKind, c.ns, opts), &v1beta1.BlockDeviceList{})
	...
	list := &v1beta1.BlockDeviceList{ListMeta: obj.(*v1beta1.BlockDeviceList).ListMeta}
	for _, item := range obj.(*v1beta1.BlockDeviceList).Items {
...
func (c *FakeBlockDevices) Create(ctx context.Context, blockDevice *v1beta1.BlockDevice, opts v1.CreateOptions) (result *v1beta1.BlockDevice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(blockdevicesResource, c.ns, blockDevice), &v1beta1.BlockDevice{})
...
func (c *FakeBlockDevices) Update(ctx context.Context, blockDevice *v1beta1.BlockDevice, opts v1.UpdateOptions) (result *v1beta1.BlockDevice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(blockdevicesResource, c.ns, blockDevice), &v1beta1.BlockDevice{})
...
func (c *FakeBlockDevices) UpdateStatus(ctx context.Context, blockDevice *v1beta1.BlockDevice, opts v1.UpdateOptions) (*v1beta1.BlockDevice, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(blockdevicesResource, "status", c.ns, blockDevice), &v1beta1.BlockDevice{})
...
func (c *FakeBlockDevices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(blockdevicesResource, c.ns, name, opts), &v1beta1.BlockDevice{})
...
func (c *FakeBlockDevices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.BlockDeviceList{})
	return err
}
...
func (c *FakeBlockDevices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BlockDevice, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(blockdevicesResource, c.ns, name, pt, data, subresources...), &v1beta1.BlockDevice{})
