...
type backupVolumes struct {
	*gentype.ClientWithList[*longhornv1beta2.BackupVolume, *longhornv1beta2.BackupVolumeList]
}

// newBackupVolumes returns a BackupVolumes
func newBackupVolumes(c *LonghornV1beta2Client, namespace string) *backupVolumes {
	return &backupVolumes{
		gentype.NewClientWithList[*longhornv1beta2.BackupVolume, *longhornv1beta2.BackupVolumeList](
			"backupvolumes",
			c.RESTClient(),
