...
func (in *LonghornProvisionerInfo) DeepCopy() *LonghornProvisionerInfo {
	if in == nil {
		return nil
	}
	out := new(LonghornProvisionerInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VolumeGroupCondition) DeepCopy() *VolumeGroupCondition {
	if in == nil {
		return nil
	}
	out := new(VolumeGroupCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VolumeGroupStatus) DeepCopyInto(out *VolumeGroupStatus) {
	*out = *in
	if in.VGConditions != nil {
		in, out := &in.VGConditions, &out.VGConditions
		*out = make([]VolumeGroupCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
